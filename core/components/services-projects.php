...
add_action( 'init', 'true_register_post_type_init_projects_services' ); // Использовать функцию только внутри хука init

function true_register_post_type_init_projects_services() {
    $labels = array(
        'name' => 'Услуги проектов',
        ...
        'menu_name' => 'Услуги проектов' // ссылка в меню в админке
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
    ...
    register_post_type('projects_services', $args);
}
