...
add_action( 'init', 'true_register_post_type_init3' ); // Использовать функцию только внутри хука init
...
function true_register_post_type_init3() {
    $labels = array(
        ...
        'menu_name' => 'Преимущества продукта' // ссылка в меню в админке
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
    ...
    register_post_type('product-advantage', $args);
}
