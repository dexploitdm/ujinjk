...
add_action( 'init', 'true_register_post_type_init_quizes' ); // Использовать функцию только внутри хука init

function true_register_post_type_init_quizes() {
    $labels = array(
        'name' => 'Квиз',
        ...
        'menu_name' => 'Квиз' // ссылка в меню в админке
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
