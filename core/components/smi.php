...
add_action( 'init', 'true_register_post_type_init_smiujinjk' ); // Использовать функцию только внутри хука init

function true_register_post_type_init_smiujinjk() {
    $labels = array(
        'name' => 'Сми',
        ...
        'menu_name' => 'Сми' // ссылка в меню в админке
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
    ...
    register_post_type('smiujinjk', $args);
}
