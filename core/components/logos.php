...
add_action( 'init', 'true_register_post_type_init_logosujinjk' ); // Использовать функцию только внутри хука init

function true_register_post_type_init_logosujinjk() {
    $labels = array(
        'name' => 'Логотипы',
        ...
        'menu_name' => 'Логотипы' // ссылка в меню в админке
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
    ...
    register_post_type('logosujinjk', $args);
}
